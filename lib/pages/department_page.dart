...
import 'package:vfactus/components/teacher_status.dart';

class DepartmentPage extends StatefulWidget {
  const DepartmentPage({super.key});

  @override
  State<DepartmentPage> createState() => _DepartmentPage();
}

class _DepartmentPage extends State<DepartmentPage> {
  // padding constants
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Total Number Of Teacher: 2",
                      style:
